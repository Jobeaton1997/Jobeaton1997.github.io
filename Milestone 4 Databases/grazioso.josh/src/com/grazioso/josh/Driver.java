...
import com.grazioso.josh.Dog;
import com.grazioso.josh.MonkeyClass;
import com.grazioso.josh.RescueAnimal;
import com.grazioso.josh.MongoDBConnection;
...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        try {
        	...
        	MongoDBConnection.loadAnimals(dogMap, monkeyMap);
    ...
    public static void intakeNewDog(Scanner scanner) {
        ...
        public static void intakeNewMonkey(Scanner scanner) {
            ...
            MongoDBConnection.saveMonkey(monkey);
        ...
        public static void testConnection() {
            ...
            try {
                ...
                mongoClient = MongoClients.create(MongoDBConnection.getURI());
                // Get the database
                MongoDatabase database = mongoClient.getDatabase(MongoDBConnection.getDatabaseName());

                // Output database connected to
